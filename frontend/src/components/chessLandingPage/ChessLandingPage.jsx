...
const ChessLandingPage = () => {
    return (
        <div className="bg-[#232320] md:ml-40 text-white font-sans min-h-screen">
            ...
            <section className="flex flex-col md:flex-row bg-[#312e2b] p-6 md:p-12 mt-8">
                ...
                <div className="w-full md:w-1/2 space-y-10 mt-6 md:mt-0 md:pr-8 flex flex-col">
                    <h2 className="text-2xl md:text-4xl text-center md:text-left font-bold order-1">Solve Chess Puzzles</h2>
            ...
            {/* News Section */}
            <section className="bg-[#312e2b] p-6 md:p-12 mt-8">
                <h2 className="text-2xl md:text-4xl font-semibold text-center mb-8">Follow what’s happening in Chess Today.</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-[#232320] p-4 rounded shadow">
                        <img src="/chessNEWS1.png" className="rounded mb-2" alt="Ju Wenjun" />
                        <h3 className="text-xl font-bold text-gray-400 text-center"><span className="text-white">Play online</span> with over 100 million members from around the world.</h3>
                        {/* <p className="text-sm font-bold text-gray-400">With over 100 million members from around the world.</p> */}
                    </div>
                    <div className="bg-[#232320] p-4 rounded shadow">
                        <img src="/chessNEWS2.png" className="rounded mb-2" alt="Magnus Carlsen" />
                        <h3 className="text-xl font-bold text-gray-400 text-center">Level up your game with fun, <span className="text-white">interactive lessons</span> from top masters and coaches. </h3>
                        {/* <p className="text-sm font-bold text-gray-400">from top masters and coaches.</p> */}
                    </div>
                    <div className="bg-[#232320] p-4 rounded shadow">
                        <img src="/chessNEWS3.png" className="rounded mb-2" alt="Banusz" />
                        <h3 className="text-xl font-bold text-gray-400 text-center">Watch the best players in the world play in the <span className="text-white">biggest events.</span> </h3>
                        {/* <p className="text-sm text-gray-400">Nathaniel Green</p> */}
                    </div>
                    <div className="bg-[#232320] p-4 rounded shadow">
                        <img src="/chessNEWS4.png" className="rounded mb-2" alt="Jan's Four Knights" />
                        <h3 className="text-xl font-bold text-gray-400 text-center"><span className="text-white">Play your friends and family</span> anytime, anywhere with fun Daily Games.</h3>
